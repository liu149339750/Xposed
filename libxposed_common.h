...
#define CLASS_XPOSED_BRIDGE  "de/robv/lw/android/xposed/XposedBridge"
#define CLASS_XRESOURCES     "android/content/res/XResources"
#define CLASS_MIUI_RESOURCES "android/content/res/MiuiResources"
#define CLASS_ZYGOTE_SERVICE "de/robv/lw/android/xposed/services/ZygoteService"
#define CLASS_FILE_RESULT    "de/robv/lw/android/xposed/services/FileResult"
